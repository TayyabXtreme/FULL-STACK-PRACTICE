  ...
  return (
    <div className='relative bg-gradient-to-r from-blue-500 to bg-indigo-600 dark:from-gray-800 dark:to-gray-900 py-24 px-4 text-center'>
        <div className='max-w-3xl mx-auto'>
            ...
            <p className='text-gray-200 dark:text-gray-400 mb-8'>Dicover, Learn, and upskill with our wide range of courses</p>    
                <form action="" className='flex items-center bg-white dark:bg-gray-800 rounded-full shadow-lg overflow-hidden max-w-xl mx-auto mb-6'>
                    ...
                    type='text' className='flex-grow border-none px-6 py-3 text-gray-900 dark:text-gray-100 focus-visible:ring-0 placeholder-gray-400 dark:placeholder-gray-500'  />
                    <Button className="bg-blue-600 dark:bg-blue-700 text-white px-6 py-3 rounded-r-full hover:bg-blue-700 dark:hover:bg-blue-800">Searh</Button>
