...
const ConfirmedRide = ({setConfirmRidePanal,setLookingForDriverPanal}) => {
  return (
    <div>
    ...
    className='w-full mt-5 bg-black text-white px-3 py-2 rounded-lg font-semibold' >Confirm</button>
    </div>
    </div>
  )
}
